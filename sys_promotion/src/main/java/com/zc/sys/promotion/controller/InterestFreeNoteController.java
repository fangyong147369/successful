...
public class InterestFreeNoteController extends BaseController<InterestFreeNoteModel> {
	...
	@ResponseBody
	public Object list(InterestFreeNoteModel model) throws BussinessException {
	...
	@ResponseBody
	public Object add(InterestFreeNoteModel model) throws BussinessException {
	...
	@ResponseBody
	public Object update(InterestFreeNoteModel model) throws BussinessException {
	...
	@ResponseBody
	public Object getById(InterestFreeNoteModel model) throws BussinessException {
