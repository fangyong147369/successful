//package com.zc.sys.sys_cashloan;
//
...
//		
//		//实体名称(生成之前需要修改)
//		String entityName = "CashLoanRepayment";
//		
//		//实体对应的数据库表名称(生成之前需要修改)
//		String tableName = "cash_loan_repayment";
//		
//		//包名称(并非完整包名，只是包含Entiy、model、Convert等的父包名)(为空时自动取实体名称的小写)
//		String packageName = "cashloan";
//		//模块名称
//		String moduleName = "现金贷还款计划";
//		//模块代码
//		String dbModel = "Cl";//首字母大写
//		//工程目录
