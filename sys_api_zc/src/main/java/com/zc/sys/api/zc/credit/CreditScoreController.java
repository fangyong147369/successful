...
public class CreditScoreController extends BaseController<CreditScoreModel> {
	...
	@ResponseBody
	public Object list(CreditScoreModel model) throws BussinessException {
	...
	@ResponseBody
	public Object add(CreditScoreModel model) throws BussinessException {
	...
	@ResponseBody
	public Object update(CreditScoreModel model) throws BussinessException {
	...
	@ResponseBody
	public Object getById(CreditScoreModel model) throws BussinessException {
