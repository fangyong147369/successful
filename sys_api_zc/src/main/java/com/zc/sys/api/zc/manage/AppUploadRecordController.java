...
public class AppUploadRecordController extends BaseController<AppUploadRecordModel> {
	...
	@ResponseBody
	public Object list(AppUploadRecordModel model) throws BusinessException {
	...
	@ResponseBody
	public Object add(AppUploadRecordModel model) throws BusinessException {
	...
	@ResponseBody
	public Object update(AppUploadRecordModel model) throws BusinessException {
	...
	@ResponseBody
	public Object getById(AppUploadRecordModel model) throws BusinessException {
