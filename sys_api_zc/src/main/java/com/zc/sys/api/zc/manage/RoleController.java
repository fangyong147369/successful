...
public class RoleController extends BaseController<RoleModel> {
	...
	@ResponseBody
	public Object list(RoleModel model) throws BussinessException {
	...
	@ResponseBody
	public Object add(RoleModel model) throws BussinessException {
	...
	@ResponseBody
	public Object update(RoleModel model) throws BussinessException {
	...
	@ResponseBody
	public Object getById(RoleModel model) throws BussinessException {
