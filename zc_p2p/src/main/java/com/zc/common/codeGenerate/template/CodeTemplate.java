package com.zc.common.codeGenerate.template;
...
public class CodeTemplate {
	...
	public CodeTemplate(String packageName, String entityName, String tableName) {
		...
		entityPackage = String.format("com.zc.%s.entity", packageName);
		modelPackage = String.format("com.zc.%s.model", packageName);
		servicePackage = String.format("com.zc.%s.service", packageName);
		serviceImplPackage = String.format("com.zc.%s.service.impl", packageName);
		controllerPackage = String.format("com.zc.%s.controller", packageName);
		daoPackage = String.format("com.zc.%s.dao", packageName);
		daoImplPackage = String.format("com.zc.%s.dao.impl", packageName);
	...
	public String entity(){
		...
		sb.append("import com.zc.sys.core.common.constant.BaseConstant;\n");
		sb.append("/**\n * "+moduleName+"\n * @author "+author+"\n * @version "+version+"\n * @since "+since+"\n */\n");
		sb.append("@Entity\n");
	...
	public String model(){
		...
		sb.append("\t\tBeanUtils.copyProperties("+entityNameLower+", "+modelName+");\n");
		sb.append("\t\treturn "+ modelNameLower+";\n");
		sb.append("\t}\n");
		sb.append("\n");
		sb.append("\t/**\n\t * model转换实体\n\t */\n");
		sb.append("\tpublic "+modelName+" prototype() {\n");
	...
	public String serviceImpl(){
		...
		sb.append("import com.zc.sys.common.form.Result;\n");
		sb.append("import ").append(daoPackage).append(".").append(daoName);
		sb.append("import ").append(modelPackage).append(".").append(modelName).append(";\n");
	...
	public String controller(){
		...
		/*
		sb.append("\tpublic ").append(modelName).append(" convertToView(").append(entityName).append(" entity) {\n");
		sb.append("\t}\n\n");
		sb.append("\t@Override\n");
		sb.append("\tpublic List<").append(modelName).append("> listByCondition(QueryCondition condition, ").append(modelName).append(" model) {\n");
		sb.append("\t\tList<").append(entityName).append("> list = ").append(serviceNameUncapitalize).append(".queryByCondition(condition);\n");
		sb.append("\t}\n\n");
		sb.append("\t@RequestMapping(value = \"/golist.do\")\n");
		sb.append("\tpublic ModelAndView golist(HttpServletRequest request) {\n");
		sb.append("\t\treturn new ModelAndView(\"/views/module/").append(packageName).append("/list.jsp\");\n");
		sb.append("\t}\n\n");
		sb.append("\t@RequestMapping(value = \"/saveEntity.do\")\n");
		sb.append("\tpublic @ResponseBody AjaxResult saveByEntity(HttpServletRequest request, ").append(entityName).append(" entity){\n");
		sb.append("\t\tLoginUser loginUser = LoginUserUtil.getCurrentUser(request);\n");
		sb.append("\t\t").append(serviceNameUncapitalize).append(".saveEntity(loginUser, entity);\n");
		sb.append("\t\treturn AjaxResult.warpAjaxResult(true);\n");
		sb.append("\t}\n\n");
		sb.append("\t@RequestMapping(value = \"/edit.do\")\n");
		sb.append("\tpublic ModelAndView edit(HttpServletRequest request, ").append(entityName).append(" entity) {\n");
		sb.append("\t\tif(entity.getOid() != null){\n");
		sb.append("\t\t\tentity = ").append(serviceNameUncapitalize).append(".find(entity.getOid());\n");
		sb.append("\t\t}\n");
		sb.append("\n");
		sb.append("\t\tHashMap<String, Object> map = new HashMap<String, Object>();\n");
		sb.append("\t\tmap.put(\"entity\", entity);\n");
		sb.append("\t\treturn new ModelAndView(\"/views/module/").append(packageName).append("/edit.jsp\", map);\n");
		sb.append("\t}\n");
		sb.append("\n");
		sb.append("}");*/
		return sb.toString();
